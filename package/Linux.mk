...
debian: $(DEB_DIR)
	...
	$(V1) $(SED_SCRIPT) debian/changelog
	$(V1) $(SED_SCRIPT) debian/control
ifeq ($(DEB_DIST), trusty)
...
install:
	...
	$(V1) sed -i -e 's/openpilotgcs/$(GCS_SMALL_NAME)/g;s/OpenPilot GCS/$(GCS_BIG_NAME)/g'
	$(V1) $(INSTALL) -T $(ROOT_DIR)/package/linux/openpilot.png $(DESTDIR)$(datadir)/pixmaps/$(OP_SMALL_NAME).png
	$(V1) rm $(DESTDIR)/$(datadir)/$(GCS_SMALL_NAME)/translations/Makefile
